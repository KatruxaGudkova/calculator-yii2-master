...
spa-build:
	@docker run --rm -v $(PWD)/frontend:/app -v $(PWD)/web:/app-web -e API_AUTH_KEY=${X_API_KEY} -e API_BASE_URL=${API_BASE_URL} localhost/calculator-spa:latest yarn run build
